    ...
    return (
        <div style={{ width: "100%", height: "100%" }}>
            {connectedToContent ? (
                <>
                    {childComponents}
                    <div style={{ ...tabContainerStyle, background }}>
                        {tabs.map((tab, i) => (
                            <div
                                key={i}
                                style={tabStyle}
                ...
                <div style={tabHelperContainer}>
                    <p style={{ ...tabHelperTextStyle, fontWeight: 600 }}>
                        Tabs
                    </p>
                    <p style={tabHelperTextStyle}>
                        Click and drag from the connector to any Frame on the
                        Canvas →
                    </p>
                </div>
            )}
